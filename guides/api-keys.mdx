...
```bash
curl -X GET https://api.cryptolay.com/api/customer/api-keys/ak_1234567890abcdef \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X PUT https://api.cryptolay.com/api/customer/api-keys/ak_1234567890abcdef \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -d '{
...
```bash
curl -X DELETE https://api.cryptolay.com/api/customer/api-keys/ak_1234567890abcdef \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
curl -X GET https://api.cryptolay.com/api/customer/api-keys/ak_1234567890abcdef/usage \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
<CardGroup cols={2}>
  <Card
    ...
    icon="lock"
  >
    Learn how to encrypt data with your API key
  </Card>
  <Card
