...
```bash
# Get recent activity
curl -X GET https://api.cryptolay.com.br/api/customer/logs \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -d '{
...
const checkActivity = async () => {
  const response = await fetch('https://api.cryptolay.com.br/api/customer/logs/recent');
...
- **Email**: security@cryptolay.com.br
...
- **Security Team**: security@cryptolay.com.br
