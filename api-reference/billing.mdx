...
<RequestExample>
```bash
curl -X GET https://api.cryptolay.com/api/customer/billing/subscription \
...
<RequestExample>
```bash
curl -X PUT https://api.cryptolay.com/api/customer/billing/subscription \
...
<RequestExample>
```bash
curl -X POST https://api.cryptolay.com/api/customer/billing/subscription/cancel \
  -H "X-API-Key: YOUR_API_KEY"
```
</RequestExample>
...
<RequestExample>
```bash
curl -X POST https://api.cryptolay.com/api/customer/billing/subscription/reactivate \
  -H "X-API-Key: YOUR_API_KEY"
```
</RequestExample>
...
<RequestExample>
```bash
curl -X GET "https://api.cryptolay.com/api/customer/billing/invoices?limit=10" \
  -H "X-API-Key: YOUR_API_KEY"
```
</RequestExample>
  ...
  "invoices": [
    {
      ...
      "pdf_url": "https://api.cryptolay.com/invoices/inv-uuid-123.pdf"
    }
  ],
  "total": 1,
  "has_more": false
...
<RequestExample>
```bash
curl -X GET https://api.cryptolay.com/api/customer/billing/invoices/inv-uuid-123 \
  -H "X-API-Key: YOUR_API_KEY"
```
</RequestExample>
...
<RequestExample>
```bash
curl -X GET https://api.cryptolay.com/api/customer/billing/payment-methods \
  -H "X-API-Key: YOUR_API_KEY"
```
</RequestExample>
...
<RequestExample>
```bash
curl -X POST https://api.cryptolay.com/api/customer/billing/payment-methods \
  -H "Content-Type: application/json" \
  -H "X-API-Key: YOUR_API_KEY" \
  -d '{
    "type": "card",
...
<RequestExample>
```bash
curl -X POST https://api.cryptolay.com/api/customer/billing/payment-methods/pm-uuid-123/default \
  -H "X-API-Key: YOUR_API_KEY"
```
</RequestExample>
...
<RequestExample>
```bash
curl -X DELETE https://api.cryptolay.com/api/customer/billing/payment-methods/pm-uuid-123 \
  -H "X-API-Key: YOUR_API_KEY"
```
</RequestExample>
...
<RequestExample>
```bash
curl -X GET https://api.cryptolay.com/api/customer/billing/usage \
  -H "X-API-Key: YOUR_API_KEY"
```
</RequestExample>
